...
first difference is stationary. More formally, KPSS tests below confirm the observations above.
...
Another feature of the data is its robust seasonal pattern, with peak in May and bottom in October almost every year (see Fig.5). This seasonality can also be seen from Fig.4. Keeling believes it was the result of the activity of land plants.
